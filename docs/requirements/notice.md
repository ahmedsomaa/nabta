...
"Implement Phase 1 only. Do not implement any Phase 2+ functionality."
...
- `docs/roadmap/` — implementation phases (start with `01-foundation/`, then `01b-marketing-site/`, then `02-academic-core/…`)
